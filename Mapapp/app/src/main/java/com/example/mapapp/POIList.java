...
public class POIList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                if (spnListMap.getSelectedItemPosition() != 0) {
                    if (!descTxt.getText().toString().isEmpty()) {
                        ...
                        Toast.makeText(POIList.this, "Debes escribir un nombre para continuar", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(POIList.this, "Debes seleccionar una ciudad para continuar", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (newList.isEmpty()) {
                    Toast.makeText(POIList.this, "Debes agregar POIs para continuar", Toast.LENGTH_SHORT).show();
                } else {
                    Intent itn = new Intent(POIList.this, MainActivity.class);
