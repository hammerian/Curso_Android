...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, LocationEngineListener,
    ...
    private Posicion originPosition;
        ...
        btnRcp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (testForm(posDesc)) {
                    ...
                    Posicion newPos = new Posicion(posDesc,newLon, newLat);
     ...
     /* if (listPos!=null) {
        ...
        map.setOnMarkerClickListener(new MapboxMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                Toast.makeText(MainActivity.this, "El marcador pulsado es " + markerName, Toast.LENGTH_SHORT).show();
                return false;
            }
        });
    }
